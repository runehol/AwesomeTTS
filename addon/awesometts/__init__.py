...
router = Router(
    services=Bundle(
        ...
        aliases=[('b', 'baidu'), ('g', 'google'), ('macosx', 'say'),
                 ...
                 ('microsoftjscript', 'sapi5js'), ('osx', 'say'),
                 ('sapi', 'sapi5'), ('sapi5jscript', 'sapi5js'),
                 ('sapijs', 'sapi5js'), ('sapijscript', 'sapi5js'),
                 ('svox', 'pico2wave'), ('svoxpico', 'pico2wave'),
                 ('ttsapi', 'ttsapicom'), ('windows', 'sapi5'),
                 ('windowsjs', 'sapi5js'), ('windowsjscript', 'sapi5js'),
                 ('y', 'yandex')],
        normalize=to.normalized_ascii,
        args=(),
